...
namespace LandMark.Common.TCP
{
    ...
    public class SocketServer
    {
        ...
        private void ProcessAccept(SocketAsyncEventArgs e)
        {
            ...
            Console.WriteLine("有 {0} 个客户端连接到服务器",
        ...
        private void ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
            {
                ...
                Console.WriteLine("服务器获取到 {0} bytes 发送过来的数据", m_totalBytesRead);

                string recStr = Encoding.UTF8.GetString(e.Buffer, 0, e.BytesTransferred);
                Console.WriteLine(recStr);

                byte[] result = Encoding.UTF8.GetBytes("服务器回传"+recStr);
